...
public class Znajdz_ksiazka2 extends ActionBarActivity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_znajdz_ksiazka2);
		
		Bundle b = getIntent().getExtras();
		odbior=b.getString("szukane");
		...
		//WCZYTYWANIE DANYCH 
			...
			String zapytanie = "SELECT * FROM ksiazka k, autor a WHERE a.ID_autor=k.ID_autor AND (k.Tytul_ks LIKE '%"+odbior+"%' || a.Nazwisko_aut LIKE '%"+odbior+"%' || k.Wyd_ks LIKE '%"+odbior+"%')";
